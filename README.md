...
This project develops a machine learning surrogate model to approximate expensive quantum-chemistry simulations of molecular hyperpolarizability.
...
Once the surrogate model is trained, it can be used to search for optimal configurations.
